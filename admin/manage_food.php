		...
		<div class="column">
			...
			<form action="" method="POST" enctype="multipart/form-data">
				<table class="tbl-full">
					...
					<tr>
                        <td>Description</td>
                        <td><input type="text"  maxlength='50' name="desc" placeholder="How many can share?"></td>
                    </tr>
					<tr>
						<td>Price</td>
						<td>
	...
	<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
			...
			?>
				<table class="tbl-full">
					...
					<?php 
						//query to get data 
						$sql3 = "SELECT * FROM tbl_food ORDER BY tbl_food.title ASC";
						$res3 = mysqli_query($conn, $sql3);
						
						$counta = mysqli_num_rows($res3);
						if($counta > 0){
							//get food then display
							while($row = mysqli_fetch_assoc($res3)){
								...
								<tr>
									...
									<td>
										<a href="<?php echo SITEURL;?>admin/mMenuFunc/update_food.php?id=<?php echo $id; ?>" class="btn-secondary">Update</a>
									
										<a href="<?php echo SITEURL;?>admin/mMenuFunc/delete_food.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name;?>" class="btn-tertiary">Delete</a> 	
									</td>
								</tr>
