							...
							if($resa == TRUE) {
								...
								if($count > 0) {
									...
									<tr>
										...
										<td>
											<a href="<?php echo SITEURL; ?>admin/mMenuFunc/update_category.php?id=<?php echo $id; ?>" class="btn-secondary">Update</a> 
											<a href="<?php echo SITEURL; ?>admin/mMenuFunc/delete_category.php?id=<?php echo $id; ?>" class="btn-tertiary">Delete</a>
										</td>
									</tr>
