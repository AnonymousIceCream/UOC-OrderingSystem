...
<head></head><title>Update Order</title><link rel="shortcut icon" href="../../img/favicon.png" type="image/png"></head>
            ...
            <div class="card">
                ...
                <?php
                    ...
                    {                        
                        ...
                        {
                            //Update Failed
                            $_SESSION['update'] = "<div class='errorcess text-center'>Order Update Failed.</div>";
                            header('location:'.SITEURL.'admin/manage_order.php');
                        }
                    }
                ?>
