...
if (isset($_POST["sbmtForgot"]))
{
     ...
     $url = "https://the-uocafe.online/admin/logInFunc/resetPass.php?selector=" . $selector . "&validator=" . bin2hex($token);
...
if(!$mail->send()){
    ...
    echo "Message sent!";
     ...
     header("location: ../admin/logInFunc/forgot.php?reset=success");
     exit();
