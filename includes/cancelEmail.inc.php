...
if ($_SESSION['status'] = 'Catering')
{
    $usrEmail= $_GET["email"];
	$to = $usrEmail;
     $subject = "Your order have been cancelled, UOCManagement";
     $message = "<p style='text-align: justify;font-size: large;font-weight: bold;'>Sadly your order have been cancelled!!</p>";
     $message .= "<p style='text-align: justify;'>Good day dear customer, <br><br> We hope that you enjoyed our services, for any questions please contact the number below: <br><br>";
