...
if ($_SESSION['status'] = 'Catering')
{
    $usrEmail= $_GET["email"];
	$to = $usrEmail;
     $subject = "Your order is on route via our delivery partner, UOCManagement";
     $message = "<p style='text-align: justify;font-size: large;font-weight: bold;'>Our delivery partner will deliver your order!!</p>";
